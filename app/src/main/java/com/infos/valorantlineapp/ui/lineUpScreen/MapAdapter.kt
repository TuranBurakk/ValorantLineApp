...
import com.infos.valorantlineapp.databinding.MapRowBinding
...
class MapAdapter(private val listener : SelectMap? = null) : RecyclerView.Adapter<MapAdapter.MapHolder>() {
    ...
    private var list = listOf<com.infos.valorantlineapp.data.entity.Map>()
    ...
    fun setData(newList : List<com.infos.valorantlineapp.data.entity.Map>){
        if (newList != null){
            list = newList
        }
